              ...
              success: function(result){
                if (result=="false"){
                  ...
                  alert("Umur masih dibawah 18 tahun");
                    ...
                    content += '<tr><td style="vertical-align:top" colspan="3"><br><b>Catatan<br>Membawa KTP/ Kartu Identitas<br>Memakai Masker<br>Tunjukan Undang ini ke vaksinator (Screenshoot/ Download)</b></td></tr>';
                    content += '</table>';
