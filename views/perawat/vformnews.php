...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        ...
        $('.cetak').click(function(){
            ...
            var url = "<?php echo site_url('perawat/cetaknews');?>/"+no_pasien+"/"+no_reg+"/"+tgl1+"/"+tgl2;
        ...
        $(".add").click(function(){
            ...
            $.ajax({
                ...
                url   : "<?php echo site_url('perawat/addtemp_news');?>",
        ...
        $(".prilaku").change(function(){
            ...
            var nilai_news_tambahan = $("[name='nilai_news_tambahan"+id+"']").val();
            var nilai_news_total = parseFloat(nilai_prilaku)+parseFloat(nilai_news_tambahan);
            $("[name='nilai_news_total"+id+"']").val(nilai_news_total);
        })
        $(".nebulizer, .muntah_post_op").change(function(){
            var id = $(this).attr("id");
            var nebulizer = $("[name='nebulizer"+id+"']").val();
            var nilai_news_tambahan = 0;
            switch (nebulizer) {
                case "Y" : nilai_news_tambahan += 2; break;
            }
            var muntah_post_op = $("[name='muntah_post_op"+id+"']").val();
            switch (muntah_post_op) {
                case "Y" : nilai_news_tambahan += 2; break;
            }
            $("[name='nilai_news_tambahan"+id+"']").val(nilai_news_tambahan);
        ...
        $(".save").click(function(){
            ...
            var gula_darah = $("[name='gula_darah"+id+"']").val();
            var cvp = $("[name='cvp"+id+"']").val();
            var lingkar_perut = $("[name='lingkar_perut"+id+"']").val();
            ...
            $.ajax({
                type  : "POST",
                data  : arrayData,
                url   : "<?php echo site_url('perawat/changesoap_news');?>",
                success : function(result){
                    // location.reload();
                    simpan();
        ...
        $(".hapus").click(function(){
            ...
            $.ajax({
                ...
                url   : "<?php echo site_url('perawat/hapustemp_news');?>",
                success : function(result){
                    simpan();
                },
                error: function(result){
    ...
    function simpan(){
        ...
        $.ajax({
            type  : "POST",
            data  : {no_reg:no_reg},
            url   : "<?php echo site_url('perawat/simpantemp_news');?>",
            success : function(result){
                location.reload();
            },
            error: function(result){
                    ...
                    if (is_array($row)){
                        ...
                        foreach ($row as $key => $value) {
                            if ($value!=""){
                                ...
                                echo "                <input name='tgl".$id."' class='form-control' readonly value='".date("d-m-Y",strtotime($this->session->userdata("tgl_news".$id)))."'>";
                                echo "            </div>";
                                echo "            <label class='col-md-2 control-label'>Jam</label>";
                                echo "            <div class='col-md-2'>";
                                echo "                <input name='jam".$id."' class='form-control' readonly value='".$this->session->userdata("jam_news".$id)."'>";
                                echo "            </div>";
                                ...
                                echo "        </div>";
                                echo "        <div class='form-group'>";
                                echo "            <label class='col-md-2 control-label'>CVP</label>";
                                echo "            <div class='col-md-2'>";
                                echo "                <input name='cvp".$id."' class='form-control' value='".$this->session->userdata("cvp".$id)."'>";
                                echo "            </div>";
                                echo "            <label class='col-md-2 control-label'>
                                                        Lingkar Perut / Lingkar Kepala
                                                  </label>";
                                echo "            <div class='col-md-2'>";
                                echo "                <input name='lingkar_perut".$id."' class='form-control' value='".$this->session->userdata("lingkar_perut".$id)."'>";
                                echo "            </div>";
                                echo "            <label class='col-md-2 control-label'>Berat Badan</label>";
                                echo "            <div class='col-md-2'>";
                                echo "                <input name='berat_badan".$id."' class='form-control' value='".$this->session->userdata("berat_badan".$id)."'>";
                                echo "            </div>";
                                echo "        </div>";
                                echo "        <div class='form-group'>";
                                echo "            <label class='col-md-2 control-label'>Tinggi Badan</label>";
                                echo "            <div class='col-md-2'>";
                                echo "                <input name='tinggi_badan".$id."' class='form-control' value='".$this->session->userdata("tinggi_badan".$id)."'>";
                                echo "            </div>";
                                echo "            <label class='col-md-2 control-label'>
                                                        Luka Skala Norton
                                                  </label>";
                                echo "            <div class='col-md-2'>";
                                echo "                <input name='luka_skala_norton".$id."' class='form-control' value='".$this->session->userdata("luka_skala_norton".$id)."'>";
                                echo "            </div>";
                                echo "            <label class='col-md-2 control-label'>Oral</label>";
                                echo "            <div class='col-md-2'>";
                                echo "                <input name='oral".$id."' class='form-control' value='".$this->session->userdata("oral".$id)."'>";
                                echo "            </div>";
                                echo "        </div>";
                                echo "        <div class='form-group'>";
                                echo "            <label class='col-md-2 control-label'>Intravena</label>";
                                echo "            <div class='col-md-2'>";
                                echo "                <input name='intravena".$id."' class='form-control' value='".$this->session->userdata("intravena".$id)."'>";
                                echo "            </div>";
                                echo "            <label class='col-md-2 control-label'>
                                                        Darah
                                                  </label>";
                                echo "            <div class='col-md-2'>";
                                echo "                <input name='darah".$id."' class='form-control' value='".$this->session->userdata("darah".$id)."'>";
                                echo "            </div>";
                                echo "            <label class='col-md-2 control-label'>Urine</label>";
                                echo "            <div class='col-md-2'>";
                                echo "                <input name='urine".$id."' class='form-control' value='".$this->session->userdata("urine".$id)."'>";
                                echo "            </div>";
                                echo "        </div>";
                                echo "        <div class='form-group'>";
                                echo "            <label class='col-md-2 control-label'>Muntah</label>";
                                echo "            <div class='col-md-2'>";
                                echo "                <input name='muntah".$id."' class='form-control' value='".$this->session->userdata("muntah".$id)."'>";
                                echo "            </div>";
                                echo "            <label class='col-md-2 control-label'>
                                                        Faeces
                                                  </label>";
                                echo "            <div class='col-md-2'>";
                                echo "                <input name='faeces".$id."' class='form-control' value='".$this->session->userdata("faeces".$id)."'>";
                                echo "            </div>";
                                echo "            <label class='col-md-2 control-label'>Drain</label>";
                                echo "            <div class='col-md-2'>";
                                echo "                <input name='drain".$id."' class='form-control' value='".$this->session->userdata("drain".$id)."'>";
                                echo "            </div>";
                                echo "        </div>";
                                echo "        <div class='form-group'>";
                                echo "            <label class='col-md-2 control-label'>IWL</label>";
                                echo "            <div class='col-md-2'>";
                                echo "                <input name='iwl".$id."' class='form-control' value='".$this->session->userdata("iwl".$id)."'>";
                                echo "            </div>";
                                echo "            <label class='col-md-2 control-label'>
                                                        Konjungtiva
                                                  </label>";
                ...
                <div class="col-xs-8">
                    <div class="form-horizontal">
                        <div class="form-group">
                            ...
                            <!-- <div class='col-md-3'>
                                <select name="tgl_pemeriksaan" class="form-control">
                                <?php
                                    foreach ($tgl_pemeriksaan as $key => $value) {
