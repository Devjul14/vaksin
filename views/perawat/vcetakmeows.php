...
<section class="margin">
    ...
    <table border="1" width="100%" cellspacing="0" cellpadding="1" style="border:1px solid #000000;">
        ...
        <tr>
            <td rowspan="5" align="center">
                <h4 style="margin-top:0px; margin-bottom: 0px;">LEMBAR OBSERVASI HARIAN<br>PASIEN MATERNITAS</h4>
            </td>
        </tr>
        <tr>
    ...
    <table border="1" width="100%" cellspacing="0" cellpadding="1">
        ...
        <tr>
            <td width=80px rowspan="12"><div class="aside" style="height: 200px;"><h5 style="bottom:-25px;">MODIFIED EARLY <br>WARNING SCORE (MEOWS)</h5></td></td>
        ...
        <tr>
            <td colspan="2" style="padding:5px;text-align: center">Tenkanan Darah DIastolik</td>
            <?php
                foreach ($r as $tgl => $val) {
                    foreach ($val as $key => $value)
        ...
        <tr>
            <td colspan="2" style="padding:5px;text-align: center">Nyeri</td>
            <?php
                foreach ($r as $tgl => $val) {
                    foreach ($val as $key => $value)
                    echo "<td class='text-center'>".$value->nyeri."</td>";
                } 
            ?>
        </tr>
        <tr>
            <td colspan="2" style="padding:5px;text-align: center">Pengeluaran/ Lochea</td>
            <?php
                foreach ($r as $tgl => $val) {
                    foreach ($val as $key => $value)
                    echo "<td class='text-center'>".$value->lochea."</td>";
                } 
            ?>
        </tr>
        <tr>
            <td colspan="2" style="padding:5px;text-align: center">Protein Urin</td>
            <?php
                foreach ($r as $tgl => $val) {
                    foreach ($val as $key => $value)
                    echo "<td class='text-center'>".$value->protein_urin."</td>";
                } 
            ?>
        </tr>
        <tr>
        ...
        <tr>
            <td width=80px rowspan="16"><div class="aside" style="height: 200px;"><h5>PENGAWASAN MATERNAL</h5></td></td>
