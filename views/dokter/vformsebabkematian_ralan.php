...
<script>
    ...
    $(document).ready(function() {
        ...
        $(".cetak").click(function() {
            ...
            var url = "<?php echo site_url('dokter/cetaksebabkematian_ralan'); ?>/" + no_reg + "/" + no_rm;
...
<div class="col-md-12">
    <div class="box box-primary">
        <div class="box-body">
            <?php
            echo form_open("dokter/simpansebabkematian_ralan/" . $aksi, array("id" => "formsave", "class" => "form-horizontal"));
            ?>
            ...
            <div class="form-horizontal">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-2 control-label">
                        <input type="text" name="poli" readonly class="form-control" value="<?php echo $pi->poli ?>">
                    </div>
                    ...
                    <div class="col-md-2 control-label">
                        <input type="text" name="no_rm" readonly class="form-control" value="<?php echo $pi->no_pasien ?>">
                    </div>
                </div>
            </div>
        </div>
